...
> --runBot :: Robot -> IO Robot
> --runBot = do penDown >> loop 5
> --             where loop n = turnLeft >> moven 3 >> loop (n-1)
>              --where loop = do c <- getLine
>                --           if c == "turnLeft" then turnLeft
>                              --if c == "move3" then moven 3;
>                              --if c == "return" then return ();
>                              --loop

-->                 penDown
-->                 c <- getLine
-->                 if c == "turnLeft" then turnLeft
-->                 else if c == "move3" then moven 3
-->                 else if c == "return" then return ()


> runRobotLoop :: Robot () -> RobotState -> Grid -> IO ()
> runRobotLoop (Robot sf) s g
>   = runGraphics $
...
> --commander = runRobot runBot s0 g0
> -- loop flow
> --  draw grid/coins/robot
